      ...
      <div className="new-footer-container">
        ...
        <div className="footer-bottom-bar">
          ...
          <div className="footer-social-icons">
            <a href="https://www.youtube.com/@CollectorsParadise" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
            ...
            <a href="https://www.instagram.com/collectorsparadisemelbourne" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="https://www.tiktok.com/@collectorsparadise" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
